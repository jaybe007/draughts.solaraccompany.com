...
async function capture(url, outPath) {
  const port = 9335;
  const userDataDir = `C:\\Users\\ayoad\\.gemini\\antigravity-ide\\brain\\797a5afa-a238-4cc1-b9c2-5d45b754c2eb\\scratch\\edge_snap_${Date.now()}`;
...
async function main() {
  ...
  await capture('http://127.0.0.1:8000/game.php', `${currentArtifactDir}\\game_lidraughts_snap.png`);
  await capture('http://127.0.0.1:8000/game.php', 'C:\\Users\\ayoad\\.gemini\\antigravity-ide\\brain\\797a5afa-a238-4cc1-b9c2-5d45b754c2eb\\game_screenshot.png');
}
