    ...
    <main class="game-container">
      ...
      <aside class="lid-game-sidebar-right">
        ...
        <div class="lid-controls-card">
          ...
          <!-- Match Action Buttons (Resign, Draw, Theme, Options) -->
          <div class="lid-action-icons-row">
            ...
            <button type="button" class="lid-action-icon-btn" id="btn-lid-theme" title="Cycle Board Theme (Default, Eco Giant, Golden State, Safari Land, Mineral Grove, Diamond Coast)">
